    ...
    <div className="min-h-screen py-16 px-4">
      ...
      <div className="max-w-4xl mx-auto text-center mb-16">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-6 leading-tight">
          Take the Free AI Income Quiz — Discover Your Personalized Path to Your First Affiliate Commission
        </h1>
        <p className="text-xl text-slate-400 max-w-2xl mx-auto">
          Answer 5 quick questions. Get an instant personalized result. Your exact next step — revealed in under 60 seconds.
        </p>
      ...
      <div className="max-w-2xl mx-auto">
        {!showResult ? (
          <GlassCard>
            <div className="mb-8">
              <div className="flex justify-between text-sm text-[#8b5cf6] font-bold mb-2">
                <span>Progress</span>
                <span>Question {currentQ + 1} of 5</span>
              </div>
          ...
          <GlassCard className="text-center">
            <div className="text-6xl mb-6 inline-block">{getResult().emoji}</div>
            <h2 className="text-3xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 to-cyan-400">
              {getResult().headline}
            </h2>
            <div className="text-slate-300 space-y-4 mb-8 text-left leading-relaxed">
              {getResult().body.split('\n\n').map((p, i) => (
                <p key={i}>{p}</p>
              ))}
            </div>
            <Button
      ...
      <footer className="mt-20 text-center text-sm text-slate-600">
        <p>© 2026 digitaltoolkt.com.ng | This quiz uses anonymous answer tracking to personalize your experience. No personal data is stored or shared.</p>
        <div className="mt-2">
